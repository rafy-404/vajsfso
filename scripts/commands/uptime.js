...
module.exports.run = async function({ api, event, args, client }) {
  ...
  let seconds = Math.floor(time % 60);
    ...
    if(url.match(lvbang) == null) return api.sendMessage({body:`╔══《🏵️✧🌺》══╗\n    𝗨𝗣𝗧𝗜𝗠𝗘 𝗥𝗢𝗕𝗢𝗧\n╚══《🏵️✧🌺》══╝\n𝐍𝐀𝐌𝐄➢ 𝐑𝐀𝐊𝐈𝐁-𝐁𝐎𝐓- 𝟎𝟎𝟕\n𝐁𝐎𝐓 𝐏𝐑𝐄𝐅𝐈𝐗 ➢ ｢ / ｣\n𝐑𝐎𝐁𝐎𝐓 𝐂𝐌𝐃➢ ｢ 210 ｣\n𝗛𝗢𝗨𝗥𝗦━➢ ${hours} \n𝗠𝗜𝗡𝗨𝗧𝗘 ━➢ ${minutes}\n𝗦𝗘𝗖𝗢𝗡𝗗 ━➢${seconds}\n𝐎𝐖𝐍𝐄𝐑➢ 𝐑𝐀𝐊𝐈𝐁 \n⋆✦▭▭▭✧◦✦◦✧▭▭▭✦⋆\n𝐂𝐫𝐞𝐚𝐭𝐨𝐫\n╰┈➤𝚁𝙰𝙺𝙸𝙱 𝙲𝙷𝙾𝚆𝙳𝙷𝚄𝚁𝚈 `, attachment: fs.createReadStream(__dirname + `/noprefix/upt.png`)}, event.threadID, event.messageID);
